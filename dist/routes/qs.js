...
const qsHandler_js_1 = require("../services/qsHandler.js");
const qsExtraction_js_1 = require("../services/qsExtraction.js");
...
router.post('/extract', async (req, res) => {
    try {
        ...
        if (drawingBase64 && drawingMimeType) {
            facts = await (0, qsExtraction_js_1.extractDrawingFacts)(formData, drawingBase64, drawingMimeType);
        }
...
router.post('/generate', async (req, res) => {
    try {
        ...
        const drawingBase64 = String(body.drawingBase64 || '');
        const drawingMimeType = String(body.drawingMimeType || '');
        const result = await (0, qsHandler_js_1.generateQS)(formData, drawingBase64 || undefined, drawingMimeType || undefined, confirmedFacts);
